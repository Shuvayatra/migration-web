		...
		<select name="deeplink" class="form-control">
			...
			<optgroup label="Post">
				@foreach($posts as $post)
					<option {{(isset($notice->deeplink) && $notice->deeplink =="shuvayatra://post?post_id=".$post['id'])?"selected":""}} value="shuvayatra://post?post_id={{$post['id']}}">{{$post['metadata']->title}}</option>
				@endforeach
			</optgroup>
