...
<div class="container">
    <?php
        ...
        $section= App\Category::find($section_id);
        $categories = $section->getImmediateDescendants();

    ?>
    <h1>{{$section->title}} <a href="{{ route('category.create') }}?section_id={{request()->get('section_id')}}" class="btn btn-primary pull-right btn-sm">Add</a></h1>
