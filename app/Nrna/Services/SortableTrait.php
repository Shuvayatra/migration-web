...
trait SortableTrait
{
    ...
    public function move($action, $entity)
    {
        ...
        $this->_transaction(
            function () use ($entity, $action) {
                ...
                $entity->setAttribute(
                    $sortableField,
                    $this->getNewPosition(!$isMoveBefore, $isMoveForward, $newPosition)
                );
    ...
    {
        return $this->sortSiblings(false, $limit);
    }
    ...
    {
        return $this->sortSiblings(true, $limit);
    }
     ...
     * @return QueryBuilder
     */
    public function sortSiblings($isNext, $limit = 0)
    {
        $sortableField = static::getSortableField();
